...
urlpatterns = [
    ...
    # PERSONAL TODOLIST
    path('todos/<int:user_id>/todolist/',
    ...
    path('todos/<int:user_id>/delete-todo/',
         views.delete_personal_todo_item, name='delete_personal_todo_item'),
    path('todos/<int:user_id>/confirm-todo-deletion/',
         views.confirm_personal_bulk_delete, name='confirm_personal_bulk_delete'),

    # TEAMS
    path('team/create_team/', views.create_team, name='create_team'),
    path('team/<int:team_id>/<int:user_id>/invite/',
         views.team_invite_confirmation, name='confirm_invite'),
    path('team/<int:team_id>/edit_team/', views.edit_team, name='edit_team'),
    path("team/<int:team_id>/delete_team/",
         views.delete_team, name="delete_team"),

    # TEAM TODOLIST
    path('team/<int:team_id>/todolist/',
